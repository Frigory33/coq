...
When you're done editing, you currently must reopen the file to see your changes.
...
Key bindings that don't appear in the file such as `Ctrl-Home` (move cursor to the beginning)
